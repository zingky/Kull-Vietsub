(function () {
    ...
    styleEl.innerHTML = `
        ...
        .g-row label { width: 95px; color: #aaa; font-weight: bold; font-size: .85em; }
        .g-row input[type="range"] { flex: 1; margin: 0 10px; height: 4px; cursor: pointer; }
        .num-in { background:rgba(255,255,255,0.1) !important; border:1px solid #444; color:#fff; min-width:45px; height:1.8em; text-align:center; border-radius:3px; padding:2px 4px; }
        .hex-in { background:rgba(255,255,255,0.1) !important; border:1px solid #444; color:#00ffaa; font-size:.85em; min-width:4.5em; text-align:center; border-radius:2px; }
        ...
        .format-btn { background:rgba(255,255,255,0.1); border:1px solid #444; color:#fff; padding:3px 10px; cursor:pointer; border-radius:3px; font-weight:bold; }
        .format-btn.active { background:#3ea6ff !important; border-color:#fff !important; color:#fff !important; }
        input[type="color"] { width:38px; height:30px; border:1px solid #444; background:rgba(255,255,255,0.1); padding:2px; cursor:pointer; border-radius:4px; }
